...
//--------------------------------------------------------------------------------------
HRESULT WINAPI DXUTCreateWindow( unsigned int defaultWidth = 640, unsigned int defaultHeight = 480, const WCHAR* strWindowTitle /*= L"Direct3D Window"*/, bool allowWindowResize /*= true*/, HINSTANCE hInstance /*= NULL*/, HICON hIcon /*= NULL*/, HMENU hMenu /*= NULL*/, int x /*= CW_USEDEFAULT*/, int y /*= CW_USEDEFAULT*/ )
{
    HRESULT hr;
    ...
    if( DXUTGetHWNDFocus() == NULL )
    {
        ...
        int nDefaultWidth = defaultWidth;
        int nDefaultHeight = defaultHeight;
		...
		if (!allowWindowResize)	dwStyle = WS_OVERLAPPEDWINDOW & ~WS_THICKFRAME & ~WS_MAXIMIZEBOX;
...
void DXUTApplyDefaultDeviceSettings(DXUTDeviceSettings *modifySettings) {
	...
	modifySettings->d3d11.CreateFlags = 0;	//by simanies: this is a bug on my machine and does not allow to create D3D Devices with debug
#else
